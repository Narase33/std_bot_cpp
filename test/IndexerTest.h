...
// ===== ===== ===== ===== ===== ===== ===== =====
	...
	threadContent += fmt::format(allFormatBlock,
		"std::token_unique0_0 std::token_unique0_1",
		"std::token_unique1_0 std::token_unique1_1",
		"std::token_unique2_0 std::token_unique2_1",
		"std::token_unique3_0 std::token_unique3_1");
	threadContent += fmt::format(allFormatBlock,
		"std::token_overwritten4_0 std::token_overwritten4_1",
		"std::token_overwritten5_0 std::token_overwritten5_1",
		"std::token_overwritten6_0 std::token_overwritten6_1",
		"std::token_overwritten7_0 std::token_overwritten7_1");
	threadContent += fmt::format(allFormatBlock,
		"std::token_overwritten_withLink8_0 std::token_overwritten_withLink8_1",
		"std::token_overwritten_withLink9_0 std::token_overwritten_withLink9_1",
		"std::token_overwritten_withLink10_0 std::token_overwritten_withLink10_1",
		"std::token_overwritten_withLink11_0 std::token_overwritten_withLink11_1");
	threadContent += fmt::format(allFormatBlock,
		"[std::token_unique12_0](link_unique_t12_0) [std::token_unique12_1](link_unique_t12_1)",
		"[std::token_unique13_0](link_unique_t13_0) [std::token_unique13_1](link_unique_t13_1)",
		"[std::token_unique14_0](link_unique_t14_0) [std::token_unique14_1](link_unique_t14_1)",
		"[std::token_unique15_0](link_unique_t15_0) [std::token_unique15_1](link_unique_t15_1)");
	threadContent += fmt::format(allFormatBlock,
		"[std::token_overwritten16_0](link_overwritten_t16_0) [std::token_overwritten16_1](link_overwritten_t16_1)",
	...
	threadContent += fmt::format(allFormatBlock,
		"[std::token_overwritten_withLink20_0](link_overwritten_withLink_t20_0) [std::token_overwritten_withLink20_1](link_overwritten_withLink_t20_1)",
	...
	threadContent += fmt::format(allFormatBlock,
		"<header_unique0_0> <header_unique0_1>",
		"<header_unique1_0> <header_unique1_1>",
		"<header_unique2_0> <header_unique2_1>",
		"<header_unique3_0> <header_unique3_1>");
	threadContent += fmt::format(allFormatBlock,
		"<header_overwritten4_0> <header_overwritten4_1>",
		"<header_overwritten5_0> <header_overwritten5_1>",
		"<header_overwritten6_0> <header_overwritten6_1>",
		"<header_overwritten7_0> <header_overwritten7_1>");
	threadContent += fmt::format(allFormatBlock,
		"<header_overwritten_withLink8_0> <header_overwritten_withLink8_1>",
		"<header_overwritten_withLink9_0> <header_overwritten_withLink9_1>",
		"<header_overwritten_withLink10_0> <header_overwritten_withLink10_1>",
		"<header_overwritten_withLink11_0> <header_overwritten_withLink11_1>");
	threadContent += fmt::format(allFormatBlock,
		"[<header_unique12_0>](link_unique_h12_0) [<header_unique12_1>](link_unique_h12_1)",
		"[<header_unique13_0>](link_unique_h13_0) [<header_unique13_1>](link_unique_h13_1)",
		"[<header_unique14_0>](link_unique_h14_0) [<header_unique14_1>](link_unique_h14_1)",
		"[<header_unique15_0>](link_unique_h15_0) [<header_unique15_1>](link_unique_h15_1)");
	threadContent += fmt::format(allFormatBlock,
		"[<header_overwritten16_0>](link_overwritten_h16_0) [<header_overwritten16_1>](link_overwritten_h16_1)",
	...
	threadContent += fmt::format(allFormatBlock,
		"[<header_overwritten_withLink20_0>](link_overwritten_withLink_h20_0) [<header_overwritten_withLink20_1>](link_overwritten_withLink_h20_1)",
	...
	std::vector<Comment> comments = {
		...
		createCommentJson(fmt::format(allFormatBlock,
			"std::token_unique24_0 std::token_unique24_1",
			"std::token_unique25_0 std::token_unique25_1",
			"std::token_unique26_0 std::token_unique26_1",
			"std::token_unique27_0 std::token_unique27_1")),

		createCommentJson(fmt::format(allFormatBlock,
			"[std::token_unique28_0](link_t28_0_) [std::token_unique28_1](link_t28_1_)",
			"[std::token_unique29_0](link_t29_0_) [std::token_unique29_1](link_t29_1_)",
			"[std::token_unique30_0](link_t30_0_) [std::token_unique30_1](link_t30_1_)",
			"[std::token_unique31_0](link_t31_0_) [std::token_unique31_1](link_t31_1_)")),

		createCommentJson(fmt::format(allFormatBlock,
			"<header_unique24_0> <header_unique24_1>",
			"<header_unique25_0> <header_unique25_1>",
			"<header_unique26_0> <header_unique26_1>",
			"<header_unique27_0> <header_unique27_1>")),

		createCommentJson(fmt::format(allFormatBlock,
			"[<header_unique28_0>](link_h28_0_) [<header_unique28_1>](link_h28_1_)",
			"[<header_unique29_0>](link_h29_0_) [<header_unique29_1>](link_h29_1_)",
			"[<header_unique30_0>](link_h30_0_) [<header_unique30_1>](link_h30_1_)",
			"[<header_unique31_0>](link_h31_0_) [<header_unique31_1>](link_h31_1_)")),
	};
